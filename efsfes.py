...
while running:
 ...
 #timer
    ...
    if elapsed_sec >= 100:
        ...
        end_text = font.render( "YYAYAYAYYA you win, it the early morning you fell asleep",True,(0, 0, 0))
        p = end_text.get_rect(center=(600, 100))
        screen.blit(end_text, p)
        end_text2 = font.render( "but it the next night tho",True,(0, 0, 0))
    ...
    if elapsed_sec >= 110:
        screen.fill((0,0,0))
        new_text = font.render("it's too bad you gotten kidnaped. HHAHHAHAHHah", True, (255,255,255))
