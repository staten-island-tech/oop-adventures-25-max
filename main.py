...
running = True
=======
image = pygame.image.load("y.png").convert_alpha()
...
>>>>>>> 16626f28f08ad8e56bf5d23766732faf1fb659a6
...
#flashlight stuff
    if light == True:
        ...
        pygame.draw.circle(screen, (255, 240, 189), (mouse_x, mouse_y), 50)
...
>>>>>>> 16626f28f08ad8e56bf5d23766732faf1fb659a6
    ...
    controls3 = font.render("Press F to open flashlight", True, (255, 255, 255))
...
=======
    ...
    if closet_lose != 0 and monster.show_closet_monster == True and run_time - closet_lose >= 10000:
        ...
        if run_time - flash_time >= 7000:
            font.render("YOU LOST", True, (255,0,0))
            screen.blit()
